...
/**
 * An implementation of [MessageWriter] that contains multiple LogWriters. This writer passes the log messages through
 * to its internal writers, allowing for multiple log outputs.
 */
